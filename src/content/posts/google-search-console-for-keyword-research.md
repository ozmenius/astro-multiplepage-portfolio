...
GSC retains performance data for a rolling 16-month window. Once a date falls outside that window, the data is permanently deleted with no way to recover it ([Google Search Central via SEO Testing](https://seotesting.com/google-search-console/data-limitations/), 2024). This isn't a soft limit. Export your full dataset to Google Sheets at least once per quarter to build a longer historical record.

### The 1,000-Row Export Cap

The GSC interface and CSV export both cap at 1,000 rows per pull. For smaller sites, that's rarely an issue. For larger sites with thousands of ranking queries, you're working with a sample, not the full picture. The GSC API allows up to 50,000 rows per day per property per search type ([Google Search Central](https://developers.google.com/webmaster-tools/limits)), which is the right solution for sites where the 1,000-row limit is binding.
...
GSC retains performance data for a rolling 16-month window. Once a date falls outside that window, the data is permanently deleted. There's no way to recover it retroactively ([Google Search Central via SEO Testing](https://seotesting.com/google-search-console/data-limitations/), 2024). Export your full dataset to Google Sheets quarterly to maintain a longer historical record for trend analysis.
...
- Ahrefs, *GSC Anonymized Queries Study (22 billion clicks, 887,534 properties)*, February 2026, https://ahrefs.com/blog/gsc-anonymized-queries/
- GrowthSRC, *Google Organic CTR Study 2025 (200,000+ keywords, 30+ websites)*, 2025, https://growthsrc.com/google-organic-ctr-study/
- Conductor, *Organic Website Traffic Industry Benchmarks Report*, 2024, https://www.conductor.com/academy/organic-website-traffic-industry-benchmarks/
- Conductor, *State of SEO Survey*, 2025, https://www.conductor.com/academy/organic-website-traffic-industry-benchmarks/
- Stan Ventures, *AI Overviews Impact on Organic CTRs*, 2025, https://www.stanventures.com/news/ai-overviews-impact-organic-ctrs-32-drop-3635/
- Google Search Central, *Search Console API Limits and Quotas*, ongoing, https://developers.google.com/webmaster-tools/limits
- SEO Testing, *Google Search Console Data Limitations*, 2024, https://seotesting.com/google-search-console/data-limitations/

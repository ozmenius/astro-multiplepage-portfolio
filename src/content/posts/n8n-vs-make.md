...
Founded in 2019, n8n raised a €55M Series B in March 2025 — at the time serving 200,000+ users and 3,000+ enterprise customers including Vodafone and Delivery Hero, with the funding explicitly tied to expanding its AI agent capabilities ([n8n Official Blog](https://blog.n8n.io/series-b/), March 2025). Just seven months later, in October 2025, it closed a much larger $180M Series C — the first round where n8n disclosed a valuation, at $2.5 billion — with its user base having grown to 230,000+ in the meantime ([n8n Official Blog](https://blog.n8n.io/series-c/), October 2025).
...
n8n's GitHub presence is equally notable: 180,000+ stars as of mid-2026, up from 123,000+ when it first topped the JavaScript Rising Stars rankings in mid-2025 ([Socket.dev](https://socket.dev/blog/n8n-tops-2025-javascript-rising-stars), July 2025; [GitHub n8n-io/n8n](https://github.com/n8n-io/n8n)). It's not a niche developer tool anymore.
...
Make.com (formerly Integromat, acquired by Celonis in October 2020 and rebranded to Make in 2022) is a no-code visual automation platform designed for business users who want to connect apps without writing code. It processed 5.6 billion scenarios in 2024, serving 3.1 million total users — a 68% year-over-year growth rate ([Make.com Official Blog](https://www.make.com/en/blog/2024-automation-wrap-up), January 2025). Those numbers reflect genuine scale.

Make operates as a semi-autonomous business unit within Celonis, headquartered in Prague with a presence in San Francisco. Its core interface is a canvas of connected circles (modules) that represents a visual workflow. Non-technical users can typically read and modify these workflows without any training, which is Make's primary differentiator.
...
n8n introduced native LangChain integration and Agent-to-Agent workflows in 2025, with its March 2025 Series B explicitly earmarked to expand AI capabilities ([n8n Official Blog](https://blog.n8n.io/series-b/), March 2025). AI agents can use other AI agents as tools within a single workflow. Make added AI module support for OpenAI, Claude, and others, but lacks native multi-agent orchestration. It's an AI add-on, not an AI-first architecture.

**Citation capsule:** n8n's Agent-to-Agent feature, launched in 2025 and backed by a €55M ($60M) Series B, enables AI agents to call other AI agents as tools within a single workflow, enabling multi-step reasoning and memory chains that Make.com cannot replicate natively. ([n8n Official Blog](https://blog.n8n.io/series-b/), March 2025)
...
**Citation capsule:** n8n ranked #1 in JavaScript Rising Stars 2025 with 123,000+ GitHub stars at the time, a figure that has since grown to 180,000+, signalling strong developer community momentum. Its fair-code license allows unlimited self-hosting for internal use, making it the only tool in this comparison that keeps workflow data fully within your own infrastructure. ([Socket.dev](https://socket.dev/blog/n8n-tops-2025-javascript-rising-stars), July 2025)

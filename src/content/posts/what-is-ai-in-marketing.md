...
<figure>
  <svg viewBox="0 0 560 320" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Horizontal bar chart showing top AI marketing use cases by adoption rate among marketers">
    <title>Top AI Marketing Use Cases by Adoption Rate</title>
    <rect width="560" height="320" fill="#0f172a" rx="12"/>
    <text x="280" y="28" text-anchor="middle" font-family="system-ui, sans-serif" font-size="14" font-weight="600" fill="#f1f5f9">Top AI Marketing Use Cases by Adoption Rate</text>
    ...
    <text x="175" y="66" text-anchor="end" font-family="system-ui" font-size="11" fill="#cbd5e1">Content Writing</text>
    ...
    <text x="175" y="106" text-anchor="end" font-family="system-ui" font-size="11" fill="#cbd5e1">Research &amp; Insights</text>
    ...
    <text x="175" y="146" text-anchor="end" font-family="system-ui" font-size="11" fill="#cbd5e1">Social Media</text>
    <rect x="180" y="132" width="114" height="22" fill="#8b5cf6" rx="3"/>
    <text x="299" y="146" font-family="system-ui" font-size="11" font-weight="600" fill="#c4b5fd">38%</text>
    <text x="175" y="186" text-anchor="end" font-family="system-ui" font-size="11" fill="#cbd5e1">Email Automation</text>
    <rect x="180" y="172" width="105" height="22" fill="#06b6d4" rx="3"/>
    <text x="290" y="186" font-family="system-ui" font-size="11" font-weight="600" fill="#67e8f9">35%</text>
    <text x="175" y="226" text-anchor="end" font-family="system-ui" font-size="11" fill="#cbd5e1">SEO Optimization</text>
    <rect x="180" y="212" width="96" height="22" fill="#10b981" rx="3"/>
    <text x="281" y="226" font-family="system-ui" font-size="11" font-weight="600" fill="#6ee7b7">32%</text>
    <text x="175" y="266" text-anchor="end" font-family="system-ui" font-size="11" fill="#cbd5e1">Paid Media</text>
    <rect x="180" y="252" width="84" height="22" fill="#f59e0b" rx="3"/>
    <text x="269" y="266" font-family="system-ui" font-size="11" font-weight="600" fill="#fcd34d">28%</text>
  </svg>
...
<figure>
  <svg viewBox="0 0 560 360" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Vertical bar chart showing reported benefits of AI in marketing by percentage of marketers citing each benefit as significant">
    <title>Reported Benefits of AI in Marketing</title>
    <rect width="560" height="360" fill="#0f172a" rx="12"/>
    <text x="280" y="28" text-anchor="middle" font-family="system-ui, sans-serif" font-size="14" font-weight="600" fill="#f1f5f9">Reported Benefits of AI in Marketing</text>
    ...
    <!-- Time Savings 82%: height=196.8, top=93.2 -->
    <rect x="72" y="93" width="50" height="197" fill="#3b82f6" rx="3 3 0 0"/>
    <text x="97" y="85" text-anchor="middle" font-family="system-ui" font-size="11" font-weight="700" fill="#93c5fd">82%</text>
    <text x="97" y="306" text-anchor="middle" font-family="system-ui" font-size="9" fill="#94a3b8">Time</text>
    <text x="97" y="318" text-anchor="middle" font-family="system-ui" font-size="9" fill="#94a3b8">Savings</text>
    <!-- Better Content 67%: height=160.8, top=129.2 -->
    <rect x="154" y="129" width="50" height="161" fill="#6366f1" rx="3 3 0 0"/>
    <text x="179" y="121" text-anchor="middle" font-family="system-ui" font-size="11" font-weight="700" fill="#a5b4fc">67%</text>
    <text x="179" y="306" text-anchor="middle" font-family="system-ui" font-size="9" fill="#94a3b8">Better</text>
    <text x="179" y="318" text-anchor="middle" font-family="system-ui" font-size="9" fill="#94a3b8">Content</text>
    <!-- Improved ROI 61%: height=146.4, top=143.6 -->
    <rect x="236" y="144" width="50" height="146" fill="#8b5cf6" rx="3 3 0 0"/>
    <text x="261" y="136" text-anchor="middle" font-family="system-ui" font-size="11" font-weight="700" fill="#c4b5fd">61%</text>
    <text x="261" y="306" text-anchor="middle" font-family="system-ui" font-size="9" fill="#94a3b8">Higher</text>
    <text x="261" y="318" text-anchor="middle" font-family="system-ui" font-size="9" fill="#94a3b8">ROI</text>
    <!-- Lower CAC 58%: height=139.2, top=150.8 -->
    <rect x="318" y="151" width="50" height="139" fill="#06b6d4" rx="3 3 0 0"/>
    <text x="343" y="143" text-anchor="middle" font-family="system-ui" font-size="11" font-weight="700" fill="#67e8f9">58%</text>
    <text x="343" y="306" text-anchor="middle" font-family="system-ui" font-size="9" fill="#94a3b8">Lower</text>
    <text x="343" y="318" text-anchor="middle" font-family="system-ui" font-size="9" fill="#94a3b8">CAC</text>
    <!-- Personalization 54%: height=129.6, top=160.4 -->
    <rect x="400" y="160" width="50" height="130" fill="#10b981" rx="3 3 0 0"/>
    <text x="425" y="152" text-anchor="middle" font-family="system-ui" font-size="11" font-weight="700" fill="#6ee7b7">54%</text>
    <text x="425" y="306" text-anchor="middle" font-family="system-ui" font-size="9" fill="#94a3b8">Personal-</text>
    <text x="425" y="318" text-anchor="middle" font-family="system-ui" font-size="9" fill="#94a3b8">ization</text>
    <!-- Content Volume 42%: height=100.8, top=189.2 -->
    <rect x="458" y="189" width="50" height="101" fill="#f59e0b" rx="3 3 0 0"/>
    <text x="483" y="181" text-anchor="middle" font-family="system-ui" font-size="11" font-weight="700" fill="#fcd34d">42%</text>
    <text x="483" y="306" text-anchor="middle" font-family="system-ui" font-size="9" fill="#94a3b8">Content</text>
    <text x="483" y="318" text-anchor="middle" font-family="system-ui" font-size="9" fill="#94a3b8">Volume</text>
    <text x="280" y="348" text-anchor="middle" font-family="system-ui" font-size="10" fill="#64748b">Source: HubSpot / Marketing AI Institute, 2025 | % of marketers citing benefit as significant</text>
  </svg>
...
<figure>
  <svg viewBox="0 0 560 340" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Donut chart showing where marketers most commonly start their AI marketing adoption journey">
    <title>Where Marketers Start with AI</title>
    <rect width="560" height="340" fill="#0f172a" rx="12"/>
    <text x="280" y="26" text-anchor="middle" font-family="system-ui, sans-serif" font-size="14" font-weight="600" fill="#f1f5f9">Where Marketers Start with AI</text>
    <!-- cx=200, cy=178, R=115, r=65 -->
    <!-- Seg 1: Content Creation 32%, -90° to 25.2° -->
    <path d="M 200 63 A 115 115 0 0 1 304.1 227.0 L 258.8 205.7 A 65 65 0 0 0 200 113 Z" fill="#3b82f6"/>
    <!-- Seg 2: SEO/Research 24%, 25.2° to 111.6° -->
    <path d="M 304.1 227.0 A 115 115 0 0 1 157.9 285.0 L 176.2 238.5 A 65 65 0 0 0 258.8 205.7 Z" fill="#10b981"/>
    <!-- Seg 3: Email Automation 19%, 111.6° to 180° -->
    <path d="M 157.9 285.0 A 115 115 0 0 1 85 178 L 135 178 A 65 65 0 0 0 176.2 238.5 Z" fill="#f59e0b"/>
    <!-- Seg 4: Paid Media 14%, 180° to 230.4° -->
    <path d="M 85 178 A 115 115 0 0 1 126.9 89.2 L 158.7 127.8 A 65 65 0 0 0 135 178 Z" fill="#ef4444"/>
    <!-- Seg 5: Analytics 11%, 230.4° to 270° -->
    <path d="M 126.9 89.2 A 115 115 0 0 1 200 63 L 200 113 A 65 65 0 0 0 158.7 127.8 Z" fill="#8b5cf6"/>
    <!-- Center hole -->
    <circle cx="200" cy="178" r="62" fill="#0f172a"/>
    <text x="200" y="172" text-anchor="middle" font-family="system-ui" font-size="11" font-weight="600" fill="#94a3b8">First</text>
    <text x="200" y="188" text-anchor="middle" font-family="system-ui" font-size="11" font-weight="600" fill="#94a3b8">Use Case</text>
    <!-- Legend -->
    <rect x="348" y="68" width="14" height="14" fill="#3b82f6" rx="2"/>
    <text x="368" y="80" font-family="system-ui" font-size="12" fill="#e2e8f0">Content Creation</text>
    <text x="368" y="95" font-family="system-ui" font-size="11" fill="#64748b">32%</text>
    <rect x="348" y="110" width="14" height="14" fill="#10b981" rx="2"/>
    <text x="368" y="122" font-family="system-ui" font-size="12" fill="#e2e8f0">SEO / Research</text>
    <text x="368" y="137" font-family="system-ui" font-size="11" fill="#64748b">24%</text>
    <rect x="348" y="152" width="14" height="14" fill="#f59e0b" rx="2"/>
    <text x="368" y="164" font-family="system-ui" font-size="12" fill="#e2e8f0">Email Automation</text>
    <text x="368" y="179" font-family="system-ui" font-size="11" fill="#64748b">19%</text>
    <rect x="348" y="194" width="14" height="14" fill="#ef4444" rx="2"/>
    <text x="368" y="206" font-family="system-ui" font-size="12" fill="#e2e8f0">Paid Media</text>
    <text x="368" y="221" font-family="system-ui" font-size="11" fill="#64748b">14%</text>
    <rect x="348" y="236" width="14" height="14" fill="#8b5cf6" rx="2"/>
    <text x="368" y="248" font-family="system-ui" font-size="12" fill="#e2e8f0">Analytics</text>
    <text x="368" y="263" font-family="system-ui" font-size="11" fill="#64748b">11%</text>
    <text x="280" y="325" text-anchor="middle" font-family="system-ui" font-size="10" fill="#64748b">Source: HubSpot / Marketing AI Institute, 2025</text>
  </svg>
  <figcaption>Source: HubSpot / Marketing AI Institute, 2025 | First AI use case by marketing function</figcaption>
</figure>
...
- HubSpot, *AI Trends Report 2025/2026*, retrieved 2026-06-22, https://www.hubspot.com/state-of-marketing

...
**12-month averaging masks seasonality.** GKP displays 12-month averages by default. A keyword with 10,000 searches in December and 200 in July shows as approximately 800/month — which misrepresents both the peak opportunity and the off-peak reality. Use the date range filter workaround mentioned above for seasonal topics.

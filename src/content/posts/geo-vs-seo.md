...
**2. Different ranking signals.** Backlinks remain the dominant signal for SEO. For GEO, citations and statistics are the primary signals. Adding citations to content improves AI visibility by 30-40%. Adding quotations delivers a similar lift. Keyword density has near-zero positive effect on GEO performance ([Aggarwal et al., ACM KDD 2024](https://arxiv.org/abs/2311.09735)). This isn't a minor adjustment. It's a fundamentally different content strategy.
...
<figure>
  <svg viewBox="0 0 580 340" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Horizontal bar chart showing GEO content strategy visibility lift by tactic, based on Aggarwal et al. ACM KDD 2024 research across 10,000 queries">
    <title>GEO Content Tactics: AI Visibility Lift by Strategy</title>
    <rect width="580" height="340" fill="#0f172a" rx="12"/>
    <text x="290" y="26" text-anchor="middle" font-family="system-ui, sans-serif" font-size="14" font-weight="600" fill="#f1f5f9">GEO Content Tactics: AI Visibility Lift</text>
    <text x="290" y="44" text-anchor="middle" font-family="system-ui, sans-serif" font-size="11" fill="#64748b">Source: Aggarwal et al., ACM KDD 2024 (GEO-bench: 10,000 queries)</text>
    <line x1="200" y1="58" x2="200" y2="295" stroke="#334155" stroke-width="1"/>
    <line x1="280" y1="58" x2="280" y2="295" stroke="#1e293b" stroke-width="1" stroke-dasharray="4,4"/>
    <line x1="360" y1="58" x2="360" y2="295" stroke="#1e293b" stroke-width="1" stroke-dasharray="4,4"/>
    <line x1="440" y1="58" x2="440" y2="295" stroke="#1e293b" stroke-width="1" stroke-dasharray="4,4"/>
    <line x1="520" y1="58" x2="520" y2="295" stroke="#334155" stroke-width="1"/>
    <text x="200" y="310" text-anchor="middle" font-family="system-ui" font-size="10" fill="#64748b">0%</text>
    <text x="280" y="310" text-anchor="middle" font-family="system-ui" font-size="10" fill="#64748b">10%</text>
    <text x="360" y="310" text-anchor="middle" font-family="system-ui" font-size="10" fill="#64748b">20%</text>
    <text x="440" y="310" text-anchor="middle" font-family="system-ui" font-size="10" fill="#64748b">30%</text>
    <text x="520" y="310" text-anchor="middle" font-family="system-ui" font-size="10" fill="#64748b">40%+</text>
    <!-- Statistics +41% -->
    <text x="196" y="79" text-anchor="end" font-family="system-ui" font-size="11" fill="#cbd5e1">Add Statistics</text>
    <rect x="200" y="65" width="164" height="22" fill="#3b82f6" rx="3"/>
    <text x="369" y="79" font-family="system-ui" font-size="11" font-weight="700" fill="#93c5fd">+41%</text>
    <!-- Citations +35% -->
    <text x="196" y="117" text-anchor="end" font-family="system-ui" font-size="11" fill="#cbd5e1">Add Citations</text>
    <rect x="200" y="103" width="140" height="22" fill="#6366f1" rx="3"/>
    <text x="345" y="117" font-family="system-ui" font-size="11" font-weight="700" fill="#a5b4fc">+35%</text>
    <!-- Quotations +30% -->
    <text x="196" y="155" text-anchor="end" font-family="system-ui" font-size="11" fill="#cbd5e1">Add Quotations</text>
    <rect x="200" y="141" width="120" height="22" fill="#8b5cf6" rx="3"/>
    <text x="325" y="155" font-family="system-ui" font-size="11" font-weight="700" fill="#c4b5fd">+30%</text>
    <!-- Fluency optimization +22% -->
    <text x="196" y="193" text-anchor="end" font-family="system-ui" font-size="11" fill="#cbd5e1">Fluency Optimization</text>
    <rect x="200" y="179" width="88" height="22" fill="#06b6d4" rx="3"/>
    <text x="293" y="193" font-family="system-ui" font-size="11" font-weight="700" fill="#67e8f9">+22%</text>
    <!-- Authoritative voice +15% -->
    <text x="196" y="231" text-anchor="end" font-family="system-ui" font-size="11" fill="#cbd5e1">Authoritative Voice</text>
    <rect x="200" y="217" width="60" height="22" fill="#10b981" rx="3"/>
    <text x="265" y="231" font-family="system-ui" font-size="11" font-weight="700" fill="#6ee7b7">+15%</text>
    <!-- Keyword stuffing ~0% -->
    <text x="196" y="269" text-anchor="end" font-family="system-ui" font-size="11" fill="#cbd5e1">Keyword Stuffing</text>
    <rect x="200" y="255" width="6" height="22" fill="#475569" rx="3"/>
    <text x="211" y="269" font-family="system-ui" font-size="11" font-weight="700" fill="#94a3b8">~0%</text>
  </svg>
...
<figure>
  <svg viewBox="0 0 520 300" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Grouped bar chart showing the growth in zero-click search rates from 2024 to early 2026, with US and EU data points from SparkToro research">
    ...
    <text x="260" y="26" text-anchor="middle" font-family="system-ui, sans-serif" font-size="14" font-weight="600" fill="#f1f5f9">Zero-Click Search Rate Growth</text>
    <text x="260" y="44" text-anchor="middle" font-family="system-ui, sans-serif" font-size="11" fill="#64748b">Source: SparkToro / Similarweb (2024-2026)</text>
    ...
    <rect x="95" y="128" width="50" height="102" fill="#3b82f6" rx="3 3 0 0"/>
    <text x="120" y="120" text-anchor="middle" font-family="system-ui" font-size="11" font-weight="700" fill="#93c5fd">58.5%</text>
    <text x="120" y="248" text-anchor="middle" font-family="system-ui" font-size="10" fill="#94a3b8">US 2024</text>
    <!-- EU 2024: 59.7% -- height = 104.5, top = 125.5 -->
    <rect x="210" y="126" width="50" height="104" fill="#6366f1" rx="3 3 0 0"/>
    <text x="235" y="118" text-anchor="middle" font-family="system-ui" font-size="11" font-weight="700" fill="#a5b4fc">59.7%</text>
    <text x="235" y="248" text-anchor="middle" font-family="system-ui" font-size="10" fill="#94a3b8">EU 2024</text>
    <!-- US Early 2026: 68.01% -- height = 119, top = 111 -->
    <rect x="360" y="111" width="50" height="119" fill="#ef4444" rx="3 3 0 0"/>
    <text x="385" y="103" text-anchor="middle" font-family="system-ui" font-size="11" font-weight="700" fill="#fca5a5">68.0%</text>
    <text x="385" y="248" text-anchor="middle" font-family="system-ui" font-size="10" fill="#94a3b8">US 2026</text>
    <!-- Legend -->
    <rect x="60" y="268" width="12" height="12" fill="#3b82f6" rx="2"/>
    <text x="76" y="278" font-family="system-ui" font-size="10" fill="#94a3b8">Prior periods</text>
    <rect x="175" y="268" width="12" height="12" fill="#ef4444" rx="2"/>
    <text x="191" y="278" font-family="system-ui" font-size="10" fill="#94a3b8">Early 2026 (record high)</text>
  </svg>
...
- Aggarwal, N. et al. (Princeton / Georgia Tech / IIT Delhi), *GEO: Generative Engine Optimization*, ACM KDD 2024, https://arxiv.org/abs/2311.09735
...
- Ahrefs, *AI Overviews: Do They Really Reduce Clicks?*, December 2025, https://ahrefs.com/blog/ai-overviews-reduce-clicks-update/
- Seer Interactive, *AI Overviews CTR Impact Study*, January 2025, https://www.seerinteractive.com/insights/ctr-aio
- BrightEdge, *Rank Overlap After 16 Months of AI Overviews*, February 2026, https://www.brightedge.com/resources/weekly-ai-search-insights/rank-overlap-after-16-months-of-aio
